...
/**
 * Clase para buscar estado de la persona en cuarentena
 *
 */

@CommonsLog
@Service("PERUC0005")
public class PERUC0005 implements TargetService {
	...
	public ModelAndView serviceCall(Map<String, Object> vo, HttpServletRequest request)  throws Exception {
		...
		try{
				...
				List<Map<String,Object>> list = ScmDao.selectList("PERU_CODE.selectSttusCodeList", vo);
